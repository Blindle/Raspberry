...
pico2wave -w=evaluate-menu.wav -l='es-ES' 'Modo Evaluacion'
pico2wave -w=config.wav -l='es-ES' 'Configuracion'

pico2wave -w=level1.wav -l='es-ES' 'Nivel 1'
pico2wave -w=level2.wav -l='es-ES' 'Nivel 2'
pico2wave -w=level3.wav -l='es-ES' 'Nivel 3'

pico2wave -w=enter-learn-menu.wav -l='es-ES' 'Entrando al menu de aprendizaje. Seleccione un nivel'
pico2wave -w=enter-evaluate-menu.wav -l='es-ES' 'Entrando al menu de evaluacion. Seleccione un nivel'
pico2wave -w=enter-write.wav -l='es-ES' 'Comienza la escritura libre, toque el boton atras para salir'
pico2wave -w=enter-config.wav -l='es-ES' 'Entrando a configuracion'

pico2wave -w=backto-menu.wav -l='es-ES' 'Regresando a menu principal'

pico2wave -w=enter-learn-level1.wav -l='es-ES' 'Entrando a nivel 1 de aprendizaje'
